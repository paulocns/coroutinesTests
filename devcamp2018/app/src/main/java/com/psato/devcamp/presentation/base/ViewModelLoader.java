...
public abstract class ViewModelLoader extends Loader<ViewModel> {
    ...
    protected abstract ViewModel initializeInjector();
    ...
    public void forceLoad() {
        super.forceLoad();
        ViewModel viewmodel = loadViewModel();
     ...
     */
    protected void onReleaseResources(ViewModel viewmodel) {
    }
}
